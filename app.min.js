...
function nav(e) {
    ...
    if (a += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${o}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`, l.forEach((e, t) => {
            a += `<a class="dropdown-item"  href="/${t}:/">${e}</a>`
        }), a += "</div></li>", a += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href="/">> Home</a>`, !t.is_search_page) {
        var s = e.trim("/").split("/"),
            r = "/";
        if (s.length > 1)
...
function requestListPath(e, t, n, a) {
    ...
    $.post(e, i, function(t, l) {
        ...
        o && o.error && "401" == o.error.code ? a && a(e) : o && o.data && n && n(o, e, i)
    }).fail(function(e) {
